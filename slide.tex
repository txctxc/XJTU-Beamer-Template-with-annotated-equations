...
% Windows系统没有PingFang SC和STSongti-SC-Bold字体,因此参照https://www.overleaf.com/learn/latex/Chinese 注释掉了或者另外选择了字体。

%\setsansfont{msyh.ttc}
%\setCJKmainfont[AutoFakeBold]{msyh.ttc}
